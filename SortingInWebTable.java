...
public class SortingInWebTable {
	public static void main(String[] args) {
        ...
        for(int i=1;i<listRows.size();i++) { // This loop is to loop all the rows
		...
		ArrayList<String> sortNames = new ArrayList<String>();
		 ...
		 for(int i=1;i<listRows1.size();i++) { // This loop is to loop all the rows
	        	...
	        	List<WebElement> listColumns1 = currentRow1.findElements(By.tagName("td")); // To get the corresponding row column
